...
(def pg_catalog_tables (update-keys pg_catalog_tables_raw #(str "pg_catalog$" %)))
(def pg_catalog_table_cols (update-vals pg_catalog_tables_raw (comp set keys)))

(def derived-tables (merge info-tables pg_catalog_tables))
