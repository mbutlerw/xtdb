...
numericExpr
    ...
    | numericExpr '*' numericExpr #MultiplyExpr
    | numericExpr '/' numericExpr #DivideExpr
    | numericExpr '+' numericExpr #AddExpr
    | numericExpr '-' numericExpr #SubtractExpr
...
qualifiedAsterisk : identifierChain '.' ASTERISK ;
